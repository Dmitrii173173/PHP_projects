                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                          ...
                          <?php foreach($array as $item):?>
                           <div class="<?php echo $item["banned"] ?> rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
